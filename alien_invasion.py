...
class AlienInvasion:
	...
	def __init__(self):
		...
		# Full screen enable.  Note: issues will arise if you have multiple monitors 
	...
	def _check_bullet_alien_collisions(self):
		...
		#collisions is a dictionary of which bullets collided with which aliens (collision[bullet] = alien)
	...
	def _update_aliens(self):
		...
		# spritecollideany checks if a singular sprite and group have collided
